...
cl = LineClient(authToken='EQ5MFl7WXMod7f0L8S3a.d30TuBRrKxkUIL7Ssvl9IG.Dc1LBOLXkC2IMDu4891FDIU88YwEDnSWC6qZkHq8YTU=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken='EQMmtGsacHjQ7sIQUiYe.A2H/ZRmW6eQ1XZWcbZhkpG.Qjj8CpvlQP6cPkyLcLlJdNsYuHRm9fxH/98MlyC5b4A=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki,ki.server.CHANNEL_ID['LINE_TIMELINE'])
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient(authToken='EQIflSCaxl4p1QZiWcl4.nSmEBo2OA24v8Q778zYtna.Dklyi2pVOAQp8HubPLbbzGwY70/3iA68vi/QbdC4ZVI=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk,kk.server.CHANNEL_ID['LINE_TIMELINE'])
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='EQeqvMXFCHtEt7qVf0ze.i/2F0kr48rlqcShBagUp+G.QpVvnvCkkHV31lpjltE1U7/CH0LuAsLuB1BlrwP+5wQ=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc,kc.server.CHANNEL_ID['LINE_TIMELINE'])
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

sw = LineClient(authToken='EQWmjDH2nO3VNWeVyLU7.I0rvRK0vLwDVYo3lblLenW.EwCX4cK1gaBMfotpssMeignWTWU9tQy4Id8w8bc+89E=')
...
poll = LinePoll(cl)
call = cl
creator = ["u0f7d2d51bad19172ae8a5eec4952fd8a"]
owner = ["u0f7d2d51bad19172ae8a5eec4952fd8a"]
admin = ["u0f7d2d51bad19172ae8a5eec4952fd8a","u4c5a38b58b22cd7c1c900e99936f61b1","u223474203bf2ad07a173911763bd4bf3"]
staff = ["u0f7d2d51bad19172ae8a5eec4952fd8a","u4c5a38b58b22cd7c1c900e99936f61b1"]
...
def help2():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage2= "      「✭PENGATURAN GRATY-BOT✭」\n" + \
                  "「🔑」 " + key + "ɪɴᴠɪᴛᴇ「ᴏɴ/ᴏғғ」\n" + \
                  "「🔑」 " + key + "sᴛɪᴄᴋᴇʀ「ᴏɴ/ᴏғғ」\n" + \
                  "「🔑」 " + key + "ᴜɴsᴇɴᴅ「ᴏɴ/ᴏғғ」\n" + \
                  "「🔑」 " + key + "sɪᴅᴇʀ「ᴏɴ/ᴏғғ」\n" + \
...
#KICKALL
                        elif "Rata" in msg.text:
                          if msg._from in admin:
                           if msg.toType == 2:
                              print("ok")
                              _name = msg.text.replace("Rata","")
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~ngrh1010")
                        ...
                        elif cmd == "graty" or cmd == "g-r":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "༺『🔰ǤRAŦY~BOT🔰』༻")
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~ngrh1010")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                Ticket = cl.reissueGroupTicket(msg.to)
                                ki.acceptGroupInvitationByTicket(msg.to,Ticket)
                                ki.sendText(msg.to, "Sαʅƙҽɳ "+str(G.name))
                                kk.acceptGroupInvitationByTicket(msg.to,Ticket)
                                kk.sendText(msg.to, "Sαʅƙҽɳ "+str(G.name))
                                kc.acceptGroupInvitationByTicket(msg.to,Ticket)
                                kc.sendText(msg.to, "Sαʅƙҽɳ "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                ki.leaveGroup(msg.to)
                                kk.sendText(msg.to, "Bye bye fams "+str(G.name))
                                kk.leaveGroup(msg.to)
                                kc.sendText(msg.to, "Bye bye fams "+str(G.name))
                                kc.leaveGroup(msg.to)
